...
var HorizontalStackReversedExample = /** @class */ (function (_super) {
    ...
    HorizontalStackReversedExample.prototype.render = function () {
        ...
        return (React.createElement(Stack_1.Stack, { gap: 5 },
            ...
            React.createElement(Stack_1.Stack, { horizontal: true, reversed: true, disableShrink: true, gap: 10, padding: 10, className: styles.root },
                React.createElement("span", null, "Item One"),
                React.createElement("span", null, "Item Two"),
                React.createElement("span", null, "Item Three")),
            React.createElement("span", null, "Item alignments"),
            React.createElement(Stack_1.Stack, { horizontal: true, reversed: true, disableShrink: true, gap: 5, padding: 10, className: styles.root, styles: { root: { height: 100 } } },
