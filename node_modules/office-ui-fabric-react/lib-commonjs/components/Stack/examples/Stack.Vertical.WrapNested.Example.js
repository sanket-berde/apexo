...
var VerticalStackWrapNestedExample = /** @class */ (function (_super) {
    ...
    VerticalStackWrapNestedExample.prototype.render = function () {
        ...
        return (React.createElement(Stack_1.Stack, { gap: 10 },
            ...
            React.createElement(Stack_1.Stack, { wrap: true, gap: '30 40', className: styles.root },
                React.createElement(Stack_1.Stack, { wrap: true, gap: '10 30', className: styles.stackOne },
                ...
                React.createElement(Stack_1.Stack, { wrap: true, gap: '20 50', className: styles.stackTwo },
                    React.createElement("span", null, "1"),
                    React.createElement("span", null, "2"),
                    React.createElement("span", null, "3")),
                React.createElement(Stack_1.Stack, { wrap: true, className: styles.stackThree },
                    React.createElement("span", null, "1"),
                    React.createElement("span", null, "2"),
                    React.createElement("span", null, "3"),
                    React.createElement("span", null, "4"),
