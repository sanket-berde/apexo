...
var HorizontalStackShrinkExample = /** @class */ (function (_super) {
    ...
    HorizontalStackShrinkExample.prototype.render = function () {
        ...
        return (React.createElement(Stack_1.Stack, { gap: 5 },
            React.createElement(Slider_1.Slider, { label: "Change the stack width to see how child items shrink:", min: 1, max: 100, step: 1, defaultValue: 100, showValue: true, onChange: this._onWidthChange }),
            React.createElement(Stack_1.Stack, { horizontal: true, gap: 5, padding: 10, className: styles.root },
                React.createElement(Stack_1.Stack.Item, { grow: true, className: styles.item }, "I shrink"),
                React.createElement(Stack_1.Stack.Item, { grow: true, className: styles.item }, "I shrink"),
                React.createElement(Stack_1.Stack.Item, { grow: true, disableShrink: true, className: styles.item, styles: { root: { width: 500 } } }, "I don't shrink"),
                React.createElement(Stack_1.Stack.Item, { grow: true, className: styles.item }, "I shrink"))));
    };
