...
var FocusZonePhotosExample = /** @class */ (function (_super) {
    ...
    FocusZonePhotosExample.prototype.render = function () {
        ...
        return (React.createElement(FocusZone_1.FocusZone, { as: "ul", className: "ms-FocusZoneExamples-photoList" }, items.map(function (item, index) { return (React.createElement("li", { key: item.id, className: "ms-FocusZoneExamples-photoCell", "aria-posinset": index + 1, "aria-setsize": items.length, "aria-label": "Photo", "data-is-focusable": true },
