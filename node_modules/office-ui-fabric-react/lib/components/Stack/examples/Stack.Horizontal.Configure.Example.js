    ...
    HorizontalStackConfigureExample.prototype.render = function () {
        ...
        return (React.createElement(Stack, { gap: 10 },
            React.createElement(Stack, { horizontal: true, disableShrink: true },
                ...
                React.createElement(Stack.Item, { grow: true },
                    React.createElement(Stack, { horizontal: true, disableShrink: true, gap: 20 },
                        React.createElement(Stack, null,
            ...
            React.createElement(Stack, { horizontal: true, disableShrink: true, gap: 20, verticalAlign: "end" },
                React.createElement(Stack.Item, { grow: true },
