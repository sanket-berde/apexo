...
var HorizontalStackWrapNestedExample = /** @class */ (function (_super) {
    ...
    HorizontalStackWrapNestedExample.prototype.render = function () {
        ...
        return (React.createElement(Stack, { gap: 10 },
            ...
            React.createElement(Stack, { horizontal: true, wrap: true, gap: '30 40', className: styles.root },
                React.createElement(Stack, { horizontal: true, wrap: true, gap: '10 30', className: styles.stackOne },
                ...
                React.createElement(Stack, { horizontal: true, wrap: true, gap: '20 50', className: styles.stackTwo },
                    React.createElement("span", null, "1"),
                    React.createElement("span", null, "2"),
                    React.createElement("span", null, "3")),
