...
var VerticalStackReversedExample = /** @class */ (function (_super) {
    ...
    VerticalStackReversedExample.prototype.render = function () {
        ...
        return (React.createElement(Stack, { gap: 5 },
            ...
            React.createElement(Stack, { reversed: true, className: styles.root },
            ...
            React.createElement(Stack, { reversed: true, gap: 10, padding: 10, className: styles.root },
                React.createElement("span", null, "Item One"),
                React.createElement("span", null, "Item Two"),
                React.createElement("span", null, "Item Three")),
            React.createElement("span", null, "Item alignments"),
            React.createElement(Stack, { reversed: true, gap: 5, padding: 10, className: styles.root },
            ...
            React.createElement(Stack, { onClick: this._onClick, padding: 10, className: styles.root },
