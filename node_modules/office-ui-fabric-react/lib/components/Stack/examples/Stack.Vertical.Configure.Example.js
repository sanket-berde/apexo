...
var VerticalStackConfigureExample = /** @class */ (function (_super) {
    ...
    VerticalStackConfigureExample.prototype.render = function () {
        var _a = this.state, numItems = _a.numItems, showBoxShadow = _a.showBoxShadow, preventOverflow = _a.preventOverflow, disableShrink = _a.disableShrink, wrap = _a.wrap, stackHeight = _a.stackHeight, autoHeight = _a.autoHeight, gap = _a.gap, paddingLeft = _a.paddingLeft, paddingRight = _a.paddingRight, paddingTop = _a.paddingTop, paddingBottom = _a.paddingBottom, verticalAlignment = _a.verticalAlignment, horizontalAlignment = _a.horizontalAlignment, hideEmptyChildren = _a.hideEmptyChildren, emptyChildren = _a.emptyChildren;
        ...
        return (React.createElement(Stack, { gap: 10 },
            React.createElement(Stack, { horizontal: true, gap: 20 },
            ...
            React.createElement(Stack, { horizontal: true, gap: 20 },
                React.createElement(Stack.Item, { grow: true },
                    React.createElement(Stack, null,
                        ...
                        React.createElement(Stack, { horizontal: true, gap: 20, verticalAlign: "end" },
                            React.createElement(Stack.Item, { grow: true },
            ...
            React.createElement(Stack, { disableShrink: disableShrink, wrap: wrap, gap: gap + ' ' + 0, padding: paddingTop + "px " + paddingRight + "px " + paddingBottom + "px " + paddingLeft + "px", verticalAlign: verticalAlignment, horizontalAlign: horizontalAlignment, className: styles.root }, this._range(1, numItems).map(function (value, index) {
                if (emptyChildren.indexOf(value.toString()) !== -1) {
                    return hideEmptyChildren ? React.createElement(Stack.Item, { key: index, className: styles.item }) : React.createElement("span", { key: index, className: styles.item });
                }
